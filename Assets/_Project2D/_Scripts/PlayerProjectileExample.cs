...
public class PlayerProjectileExample : PlayerProjectile
{
    ...
    #region LIFE CYCLE METHODS
        ...
        {
            base.PlayerProjectileFixedUpdate();
        }
